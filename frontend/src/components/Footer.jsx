          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-5 py-4 bg-stone-900 border-2 border-stone-800 hover:border-stone-700 focus:border-amber-500 focus:outline-none rounded-xl text-white placeholder-stone-500 font-medium transition-colors"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-4">
                <a href="tel:+902121234567" className="flex items-center text-stone-400 hover:text-amber-400 transition-colors group">
                  <div className="w-10 h-10 bg-stone-900 group-hover:bg-amber-900/30 border border-stone-800 rounded-xl flex items-center justify-center mr-3 transition-colors">
                    <Phone className="w-4 h-4" />
                  </div>
                  <span className="font-bold">+90 (212) 123 45 67</span>
                </a>
                <a href="mailto:info@restorax.com" className="flex items-center text-stone-400 hover:text-amber-400 transition-colors group">
                  <div className="w-10 h-10 bg-stone-900 group-hover:bg-amber-900/30 border border-stone-800 rounded-xl flex items-center justify-center mr-3 transition-colors">
                ...
                <div className="flex items-start text-stone-400">
                  <div className="w-10 h-10 bg-stone-900 border border-stone-800 rounded-xl flex items-center justify-center mr-3 flex-shrink-0">
            ...
            <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
              {Object.entries(footerLinks).map(([category, links]) => (
                <div key={category}>
                  <h3 className="text-white font-black text-base mb-6 uppercase tracking-wider">{category}</h3>
                  <ul className="space-y-3">
                    {links.map((link) => (
                      <li key={link.label}>
                        <a
                          href={link.href}
                          className="text-stone-400 hover:text-amber-400 transition-colors text-sm font-semibold flex items-center group"
                        >
            ...
            <div className="flex space-x-3">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a 
                  key={i}
                  href="#" 
                  className="w-11 h-11 bg-stone-900 hover:bg-amber-900/30 border border-stone-800 hover:border-amber-700 rounded-xl flex items-center justify-center text-stone-400 hover:text-amber-400 transition-all duration-200 hover:scale-110"
                >
